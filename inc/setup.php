...
if ( ! function_exists ( 'understrap_setup' ) ) {
	...
	function understrap_setup() {
		...
		register_nav_menus( array(
			...
			'footer-menu-three' 	=> __( 'Footer Widget Menu Three', 'understrap' ),
			'footer-menu-four' 		=> __( 'Footer Widget Menu Four', 'understrap' ),
		) );
...
if ( ! function_exists( 'understrap_all_excerpts_get_more_link' ) ) {
	...
	function understrap_all_excerpts_get_more_link( $post_excerpt ) {
		if ( ! is_admin() ) {
			$post_excerpt = $post_excerpt . ' ...<p><a class="read-more understrap-read-more-link" href="' . esc_url( get_permalink( get_the_ID() ) ) . '">' . __( 'Read more',
			'understrap' ) . '</a></p>';
		}
		return $post_excerpt;
	}
...
// trim excerpt length
add_filter( 'excerpt_length', 'understrap_excerpt_length', 999 );
