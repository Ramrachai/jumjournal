...
gulp.task('copy-assets', function(done) {
	...
	//Copy imagesloaded js file
	gulp
		.src(`${paths.node}imagesloaded/*.js`)
		.pipe(gulp.dest(`${paths.dev}/js/imagesloaded`));

	//Copy mixitup js file
	gulp 
		.src(`${paths.node}mixitup/dist/*.js`)
		.pipe(gulp.dest(`${paths.dev}/js/mixitup`));
	
	//Copy magnific-popup js file
	gulp 
		.src(`${paths.node}magnific-popup/dist/*.js`)
		.pipe(gulp.dest(`${paths.dev}/js/magnific-popup`));

	//Copy owl.carousel js file
	gulp 
		.src(`${paths.node}owl.carousel/dist/*.js`)
		.pipe(gulp.dest(`${paths.dev}/js/owl-carousel`));

	//Copy masonry-layout js file
	gulp 
		.src(`${paths.node}masonry-layout/dist/*.js`)
		.pipe(gulp.dest(`${paths.dev}/js/masonry-layout`));
	
	//Copy infinite-scroll js file
	gulp 
		.src(`${paths.node}infinite-scroll/dist/*.js`)
  ...
  // external library css from nodemodules to /src/css
    gulp 
		.src(`${paths.node}bootstrap/dist/css/*.css`)
		.pipe(gulp.dest(`${paths.dev}/css/bootstrap`));

	gulp 
		.src(`${paths.node}@fortawesome/fontawesome-free/css/*.css`)
		.pipe(gulp.dest(`${paths.dev}/css/fontawesome`));

	gulp 
		.src(`${paths.node}magnific-popup/dist/*.css`)
		.pipe(gulp.dest(`${paths.dev}/css/magnific-popup`));
	
	gulp 
		.src(`${paths.node}owl.carousel/dist/assets/**/*.css`)
	...
	// Copy all magnific-popup SCSS files
	gulp
		.src(`${paths.node}@fortawesome/fontawesome-free/scss/*.scss`)
		.pipe(gulp.dest(`${paths.dev}/sass/fontawesome`));
